...
export const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-[85vh] overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/5">
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            >
              <Button 
                ...
                className="text-lg px-8 py-6 bg-primary hover:bg-primary/90 group will-change-transform"
              >
              ...
              <Button 
                ...
                className="text-lg px-8 py-6 border-2 hover:bg-primary/5 will-change-transform"
              >
      ...
      {/* Decorative elements avec optimisation */}
      <div className="absolute top-1/4 left-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl will-change-auto" />
      <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-secondary/5 rounded-full blur-3xl will-change-auto" />
    </div>
  );
};